  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto">
        ...
        {/* 能力说明 */}
        <div className="bg-[#171717] rounded-lg p-4 md:p-5 mb-6 border border-[#303030]">
        ...
        <div className="bg-[#171717] rounded-lg shadow-lg p-4 md:p-5 mb-6 border border-[#303030]">
        ...
        {/* 如何获取 Power BI 嵌入代码 */}
        <div className="bg-[#171717] rounded-lg shadow-lg p-4 md:p-5 border border-[#303030]">
          <h3 className="text-lg font-semibold text-[#fafafa] mb-4">
            如何获取 Power BI 嵌入代码
          </h3>
